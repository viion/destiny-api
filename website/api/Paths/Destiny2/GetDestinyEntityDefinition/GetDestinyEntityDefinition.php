...
namespace Destiny2\Api\Paths\Destiny2\GetDestinyEntityDefinition;

/**
 * GetDestinyEntityDefinition
 *
 * Returns the static definition of an entity of the given Type and hash
 * identifier. Examine the API Documentation for the Type Names of entities that
 * have their own definitions. Note that the return type will always *inherit from*
...
class GetDestinyEntityDefinition
{
    ...
    const SUMMARY = 'Destiny2.GetDestinyEntityDefinition';
