...
namespace Destiny2\Api\Enums\Destiny\DestinyGatingScope;
 ...
 * "globally" scoped unlock data may be assumed as the worst case unless it has
 * been specifically whitelisted as otherwise. That sucks, but them's the breaks.
 */
