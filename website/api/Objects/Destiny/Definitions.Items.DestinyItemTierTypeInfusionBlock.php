...
/**
 * Definitions.Items.DestinyItemTierTypeInfusionBlock
 */
class Definitions.Items.DestinyItemTierTypeInfusionBlock
{

    const NAME = 'Destiny.Definitions.Items.DestinyItemTierTypeInfusionBlock';
