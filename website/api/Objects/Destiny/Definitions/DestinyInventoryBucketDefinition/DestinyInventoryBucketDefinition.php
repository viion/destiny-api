...
namespace Destiny2\Api\Objects\Destiny\Definitions\DestinyInventoryBucketDefinition;
 ...
 * will tell you which bucket they are currently residing in
 * (DestinyItemComponent.bucketHash). You can use this information along with the
