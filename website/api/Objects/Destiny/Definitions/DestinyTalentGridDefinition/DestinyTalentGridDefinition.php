...
namespace Destiny2\Api\Objects\Destiny\Definitions\DestinyTalentGridDefinition;
 ...
 * In Destiny 2, for now, talent grids have become exclusively used by
 * Subclass/Build items: but the system is still in place for it to be used by
 * items should the direction change back toward talent grids.
 ...
 * with the instanced data to give the user the visual representation of their
 * item's talent grid.
 */
