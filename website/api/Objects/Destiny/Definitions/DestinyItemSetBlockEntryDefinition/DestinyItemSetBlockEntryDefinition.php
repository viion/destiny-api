...
namespace Destiny2\Api\Objects\Destiny\Definitions\DestinyItemSetBlockEntryDefinition;

/**
 * DestinyItemSetBlockEntryDefinition
 *
 * Defines a particular entry in an ItemSet (AKA a particular Quest Step in a
 * Quest)
 */
