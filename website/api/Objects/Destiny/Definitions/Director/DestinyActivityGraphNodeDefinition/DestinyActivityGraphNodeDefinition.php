...
namespace Destiny2\Api\Objects\Destiny\Definitions\Director\DestinyActivityGraphNodeDefinition;
 ...
 * active Activity at a time, which will determine the activity to be launched
 * (and, unless overrideDisplay information is provided, will also determine the
