...
namespace Destiny2\Api\Objects\Destiny\Definitions\DestinyActivityInsertionPointDefinition;

/**
 * DestinyActivityInsertionPointDefinition
 *
 * A point of entry into an activity, gated by an unlock flag and with some
 * more-or-less useless (for our purposes) phase information. I'm including it in
 * case we end up being able to bolt more useful information onto it in the
 * future.
