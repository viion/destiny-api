...
/**
 * Components.Vendors.DestinyVendorSaleItemBaseComponent
 */
class Components.Vendors.DestinyVendorSaleItemBaseComponent
{

    const NAME = 'Destiny.Components.Vendors.DestinyVendorSaleItemBaseComponent';
