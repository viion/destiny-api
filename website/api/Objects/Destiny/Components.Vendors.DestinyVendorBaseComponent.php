...
/**
 * Components.Vendors.DestinyVendorBaseComponent
 */
class Components.Vendors.DestinyVendorBaseComponent
{

    const NAME = 'Destiny.Components.Vendors.DestinyVendorBaseComponent';
