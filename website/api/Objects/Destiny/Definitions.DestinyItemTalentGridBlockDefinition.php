...
/**
 * Definitions.DestinyItemTalentGridBlockDefinition
 */
class Definitions.DestinyItemTalentGridBlockDefinition
{

    const NAME = 'Destiny.Definitions.DestinyItemTalentGridBlockDefinition';
