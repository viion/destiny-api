...
/**
 * Components.Presentation.DestinyPresentationNodeComponent
 */
class Components.Presentation.DestinyPresentationNodeComponent
{

    const NAME = 'Destiny.Components.Presentation.DestinyPresentationNodeComponent';
