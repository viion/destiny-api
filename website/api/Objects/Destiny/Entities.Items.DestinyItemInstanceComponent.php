...
/**
 * Entities.Items.DestinyItemInstanceComponent
 */
class Entities.Items.DestinyItemInstanceComponent
{

    const NAME = 'Destiny.Entities.Items.DestinyItemInstanceComponent';
