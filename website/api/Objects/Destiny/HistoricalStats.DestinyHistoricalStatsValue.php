...
/**
 * HistoricalStats.DestinyHistoricalStatsValue
 */
class HistoricalStats.DestinyHistoricalStatsValue
{

    const NAME = 'Destiny.HistoricalStats.DestinyHistoricalStatsValue';
