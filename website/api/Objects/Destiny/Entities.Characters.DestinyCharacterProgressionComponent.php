...
/**
 * Entities.Characters.DestinyCharacterProgressionComponent
 */
class Entities.Characters.DestinyCharacterProgressionComponent
{

    const NAME = 'Destiny.Entities.Characters.DestinyCharacterProgressionComponent';
