...
/**
 * Entities.Vendors.DestinyVendorSaleItemComponent
 */
class Entities.Vendors.DestinyVendorSaleItemComponent
{

    const NAME = 'Destiny.Entities.Vendors.DestinyVendorSaleItemComponent';
