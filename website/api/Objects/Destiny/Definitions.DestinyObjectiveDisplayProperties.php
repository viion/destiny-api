...
/**
 * Definitions.DestinyObjectiveDisplayProperties
 */
class Definitions.DestinyObjectiveDisplayProperties
{

    const NAME = 'Destiny.Definitions.DestinyObjectiveDisplayProperties';
