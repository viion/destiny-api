...
/**
 * Definitions.Records.DestinyRecordCompletionBlock
 */
class Definitions.Records.DestinyRecordCompletionBlock
{

    const NAME = 'Destiny.Definitions.Records.DestinyRecordCompletionBlock';
