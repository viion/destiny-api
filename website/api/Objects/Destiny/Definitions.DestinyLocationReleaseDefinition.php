...
/**
 * Definitions.DestinyLocationReleaseDefinition
 */
class Definitions.DestinyLocationReleaseDefinition
{

    const NAME = 'Destiny.Definitions.DestinyLocationReleaseDefinition';
