...
namespace Destiny2\Api\Objects\Destiny\Reporting\Requests\DestinyReportOffensePgcrRequest;
 ...
 * Note that this request object doesn't have the actual PGCR ID nor your
 * Account/Character ID in it. We will infer that information from your
 * authentication information and the PGCR ID that you pass into the URL of the
 * reporting endpoint itself.
 */
