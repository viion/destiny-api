...
/**
 * Entities.Items.DestinyItemObjectivesComponent
 */
class Entities.Items.DestinyItemObjectivesComponent
{

    const NAME = 'Destiny.Entities.Items.DestinyItemObjectivesComponent';
