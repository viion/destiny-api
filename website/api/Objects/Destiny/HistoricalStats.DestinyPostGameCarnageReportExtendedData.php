...
/**
 * HistoricalStats.DestinyPostGameCarnageReportExtendedData
 */
class HistoricalStats.DestinyPostGameCarnageReportExtendedData
{

    const NAME = 'Destiny.HistoricalStats.DestinyPostGameCarnageReportExtendedData';
