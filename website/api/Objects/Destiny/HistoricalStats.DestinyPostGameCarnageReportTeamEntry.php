...
/**
 * HistoricalStats.DestinyPostGameCarnageReportTeamEntry
 */
class HistoricalStats.DestinyPostGameCarnageReportTeamEntry
{

    const NAME = 'Destiny.HistoricalStats.DestinyPostGameCarnageReportTeamEntry';
