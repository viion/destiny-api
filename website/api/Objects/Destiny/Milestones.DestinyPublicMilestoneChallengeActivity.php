...
/**
 * Milestones.DestinyPublicMilestoneChallengeActivity
 */
class Milestones.DestinyPublicMilestoneChallengeActivity
{

    const NAME = 'Destiny.Milestones.DestinyPublicMilestoneChallengeActivity';
