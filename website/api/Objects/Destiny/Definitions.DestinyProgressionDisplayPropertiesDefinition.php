...
/**
 * Definitions.DestinyProgressionDisplayPropertiesDefinition
 */
class Definitions.DestinyProgressionDisplayPropertiesDefinition
{

    const NAME = 'Destiny.Definitions.DestinyProgressionDisplayPropertiesDefinition';
