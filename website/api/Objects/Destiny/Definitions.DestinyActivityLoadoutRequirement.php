...
/**
 * Definitions.DestinyActivityLoadoutRequirement
 */
class Definitions.DestinyActivityLoadoutRequirement
{

    const NAME = 'Destiny.Definitions.DestinyActivityLoadoutRequirement';
