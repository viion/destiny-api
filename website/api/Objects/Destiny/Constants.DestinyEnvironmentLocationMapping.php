...
/**
 * Constants.DestinyEnvironmentLocationMapping
 */
class Constants.DestinyEnvironmentLocationMapping
{

    const NAME = 'Destiny.Constants.DestinyEnvironmentLocationMapping';
