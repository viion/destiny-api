...
/**
 * Definitions.DestinyItemObjectiveBlockDefinition
 */
class Definitions.DestinyItemObjectiveBlockDefinition
{

    const NAME = 'Destiny.Definitions.DestinyItemObjectiveBlockDefinition';
