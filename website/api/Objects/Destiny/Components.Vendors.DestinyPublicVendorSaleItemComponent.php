...
/**
 * Components.Vendors.DestinyPublicVendorSaleItemComponent
 */
class Components.Vendors.DestinyPublicVendorSaleItemComponent
{

    const NAME = 'Destiny.Components.Vendors.DestinyPublicVendorSaleItemComponent';
