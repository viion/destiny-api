...
/**
 * Definitions.DestinyProgressionMappingDefinition
 */
class Definitions.DestinyProgressionMappingDefinition
{

    const NAME = 'Destiny.Definitions.DestinyProgressionMappingDefinition';
