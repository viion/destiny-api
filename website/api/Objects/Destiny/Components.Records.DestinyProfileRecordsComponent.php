...
/**
 * Components.Records.DestinyProfileRecordsComponent
 */
class Components.Records.DestinyProfileRecordsComponent
{

    const NAME = 'Destiny.Components.Records.DestinyProfileRecordsComponent';
