...
/**
 * Milestones.DestinyPublicMilestoneActivityVariant
 */
class Milestones.DestinyPublicMilestoneActivityVariant
{

    const NAME = 'Destiny.Milestones.DestinyPublicMilestoneActivityVariant';
