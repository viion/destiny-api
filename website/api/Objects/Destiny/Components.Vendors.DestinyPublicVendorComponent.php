...
/**
 * Components.Vendors.DestinyPublicVendorComponent
 */
class Components.Vendors.DestinyPublicVendorComponent
{

    const NAME = 'Destiny.Components.Vendors.DestinyPublicVendorComponent';
