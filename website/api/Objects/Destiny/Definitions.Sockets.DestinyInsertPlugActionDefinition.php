...
/**
 * Definitions.Sockets.DestinyInsertPlugActionDefinition
 */
class Definitions.Sockets.DestinyInsertPlugActionDefinition
{

    const NAME = 'Destiny.Definitions.Sockets.DestinyInsertPlugActionDefinition';
