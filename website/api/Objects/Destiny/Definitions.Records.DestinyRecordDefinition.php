...
/**
 * Definitions.Records.DestinyRecordDefinition
 */
class Definitions.Records.DestinyRecordDefinition
{

    const NAME = 'Destiny.Definitions.Records.DestinyRecordDefinition';
