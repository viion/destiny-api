...
/**
 * Definitions.DestinyItemSocketEntryDefinition
 */
class Definitions.DestinyItemSocketEntryDefinition
{

    const NAME = 'Destiny.Definitions.DestinyItemSocketEntryDefinition';
