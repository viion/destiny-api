...
/**
 * Definitions.DestinyItemPreviewBlockDefinition
 */
class Definitions.DestinyItemPreviewBlockDefinition
{

    const NAME = 'Destiny.Definitions.DestinyItemPreviewBlockDefinition';
