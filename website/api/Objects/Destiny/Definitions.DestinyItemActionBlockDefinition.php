...
/**
 * Definitions.DestinyItemActionBlockDefinition
 */
class Definitions.DestinyItemActionBlockDefinition
{

    const NAME = 'Destiny.Definitions.DestinyItemActionBlockDefinition';
