...
/**
 * Definitions.DestinyDisplayCategoryDefinition
 */
class Definitions.DestinyDisplayCategoryDefinition
{

    const NAME = 'Destiny.Definitions.DestinyDisplayCategoryDefinition';
