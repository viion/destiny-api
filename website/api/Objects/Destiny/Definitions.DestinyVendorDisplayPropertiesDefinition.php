...
/**
 * Definitions.DestinyVendorDisplayPropertiesDefinition
 */
class Definitions.DestinyVendorDisplayPropertiesDefinition
{

    const NAME = 'Destiny.Definitions.DestinyVendorDisplayPropertiesDefinition';
