...
/**
 * Definitions.Items.DestinyItemPlugDefinition
 */
class Definitions.Items.DestinyItemPlugDefinition
{

    const NAME = 'Destiny.Definitions.Items.DestinyItemPlugDefinition';
